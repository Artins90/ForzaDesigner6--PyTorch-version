...
from fd6.shapegen.shapes.base import Shape, _clip_bbox, _clamp, _register, SHAPE_REGISTRY
...
class Rectangle(Shape):
    ...
    def from_json(cls, data: dict) -> "Rectangle":
        return cls(
            ...
            rx=float(data.get("rx", data.get("hw", 1.0))), 
            ry=float(data.get("ry", data.get("hh", 1.0))),
        )
...
SHAPE_REGISTRY["rectangle"] = RotatedRectangle